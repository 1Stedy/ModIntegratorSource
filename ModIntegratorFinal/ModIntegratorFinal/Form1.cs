...
namespace ModIntegratorFinal
{
    public partial class Form1 : Form
    {
        ...
        void LoadText()
        {
            ...
            {
                message[0] = "Привет! Следуй дальнейшим инструкциям.\n\nСначала выбери действие.";
                message[1] = "Теперь выбери путь к корневой папке твоего мода\nНапример: C:\\Victoria2\\mod\\Mymod\n\nЗАМЕЧАНИЕ: Если в твоем моде нет continent.txt, будет использован файл оригинальной игры (из HoD 3.03).";
                message[2] = "Выбери версию мода и локализацию\n\nПосле выбора ты будешь перемещен на финальный шаг, но сможешь вернуться к выбору используя стрелки навигации.";
                message[3] = "Программа готова! Нажми кнопку запуска для начала процесса.\n\nЗАМЕЧАНИЕ: Ты можешь изменить свой выбор, вернувшись назад с помощью стрелок навигации.";
            }
            else
            {
